...
pub const main = if (builtin.mode == .Debug) @import("main_full.zig").mainFull else run;
...
pub fn eventLoop(monitor: *Monitor, blocker: *Blocker, notifier: *Notifier, config: *Config, clipboard_cleared: *bool) !void {
